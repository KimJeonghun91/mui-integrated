 ...
 */
export declare function useSlotProps<ElementType extends React.ElementType, SlotProps, AdditionalProps, OwnerState>(parameters: UseSlotPropsParameters<ElementType, SlotProps, object, WithCommonProps<Record<string, any>>, AdditionalProps, OwnerState>): import("my-mui/types").Simplify<import("my-mui/types").Simplify<SlotProps & object & AdditionalProps & {

...
- &#8203;<!-- 17 -->Remove unused dev dependency on my-mui/lab (#41198) @brijeshb42
- &#8203;<!-- 15 -->[Slider] Deprecate components and componentProps props for v6 (#40777) @lhilgert9

### `my-mui/system@5.15.12`
...
- &#8203;<!-- 04 -->[zero] Move extendTheme to already existing my-mui/zero-runtime/utils (#41254) @brijeshb42
...
- &#8203;<!-- 40 -->[code-infra] Embed translations in the my-mui/docs package (#41246) @Janpot
...
- [changelog] Remove my-mui/system@5.15.10 (#41093) @michaldudak
- [code-infra] Move typescript-to-proptypes to internal-scripts package (#41079) @michaldudak
- [code-infra] Move Link to my-mui/docs (#40889) @Janpot
...
- [core][base-ui] Remove `my-mui/base` dev dependency from Base UI workspace (#41216) @ZeeshanTamboli
...
- 🐛 A critical fix to remove non-published library usage in `my-mui/material` peerDependencies.

### `my-mui/material@5.15.9`
...
- &#8203;<!-- 20 -->[code-infra] Remove unnecessary my-mui/utils dependency from api-docs-builder (#40632) @michaldudak
...
### `my-mui/material-next@6.0.0-alpha.118`

- &#8203;<!-- 36 -->[ButtonGroup] Apply MD3 style to `ButtonGroup` (#40124) @lhilgert9

### `my-mui/base@5.0.0-beta.32`
...
### `my-mui/codemod@5.15.5`

- &#8203;<!-- 31 -->Allow `json` files to be transformed (#40536) @ZeeshanTamboli

### `my-mui/lab@5.0.0-alpha.161`

- &#8203;<!-- 09 -->Update `my-mui/material` peer dependency version (#40528) @ZeeshanTamboli

### `my-mui/material-nextjs@5.15.5`

- &#8203;<!-- 08 -->Fix release script (#40519) @petrovmiroslav
- &#8203;<!-- 07 -->Support Nonces in the App Router Provider (#40269) @josh-feldman
- &#8203;<!-- 06 -->Polish my-mui/material-nextjs (#40473) @oliviertassinari

### `my-mui/system@5.15.5`

- &#8203;<!-- 05 -->Fix import path for my-mui/system in vite apps (#40490) @brijeshb42
...
### `my-mui/material-nextjs@5.15.4`

- Improve build size issue (#40436) @siriwatknp

### `my-mui/icons-material@5.15.4`

- Update the icons (#40365) @michaldudak

### `my-mui/system@5.15.4`
...
- &#8203;<!-- 36 -->[code-infra] Break package dependency cycle between my-mui/material and my-mui/icons-material (#40400) @michaldudak
...
### `my-mui/material-next@6.0.0-alpha.115`
...
### `my-mui/styled-engine-sc@6.0.0-alpha.9`
...
### `my-mui/material-next@6.0.0-alpha.112`
...
### `my-mui/joy@5.0.0-beta.16`

- &#8203;<!-- 38 -->[Box] Added boxClasses (#39895) @sadik-malik

### `my-mui/system@5.14.19`
...
### `my-mui/material-next@6.0.0-alpha.111`
...
### `my-mui/material-next@6.0.0-alpha.110`
...
### `my-mui/material-next@6.0.0-alpha.108`
...
- &#8203;<!-- 13 -->[system] Clean up `my-mui/styles` docs and discourage users from installing it (#39644) @samuelsycamore
...
### `my-mui/material-next@6.0.0-alpha.107`
...
### `my-mui/lab@5.0.0-alpha.150`

- &#8203;<!-- 09 -->Update peer dep of my-mui/material (#39398) @brijeshb42

### `@pigment-css/react@0.0.1-alpha.0`

- &#8203;<!-- 06 -->Implement typings for public runtime API (#39215) @brijeshb42

### `my-mui/zero-vite-plugin@0.0.1-alpha.0`
...
### `my-mui/base@5.0.0-beta.19`

- [Menu] Add the anchor prop (#39297) @michaldudak

### `my-mui/material-next@6.0.0-alpha.105`

- [Menu] Copy v5 Menu components (#39301) @mnajdova

### `my-mui/joy@5.0.0-beta.10`
...
### `my-mui/styled-engine-sc@6.0.0-alpha.1`
...
### `my-mui/material-next@6.0.0-alpha.104`
...
### `my-mui/material-next@6.0.0-alpha.103`

- [FormControl] Copy v5 FormControl (#39039) @mj12albert

### `my-mui/lab@5.0.0-alpha.146`
...
- &#8203;<!-- 18 -->[core] Allow deeper import of my-mui/utils (#38806) @oliviertassinari
- &#8203;<!-- 17 -->[core] Remove react-dom from my-mui/utils peerDependencies (#38974) @michaldudak
...
### `my-mui/lab@5.0.0-alpha.144`

- &#8203;<!-- 09 -->Add TypeScript deprecations (#38833) @oliviertassinari
- &#8203;<!-- 08 -->Fix `my-mui/x-tree-view` dependency (#38822) @flaviendelangle

### `my-mui/system@5.14.9`
...
### `my-mui/base@5.0.0-beta.12`

- [Popup] New component (#37960) @michaldudak

### `my-mui/joy@5.0.0-beta.3`
...
### `my-mui/material-next@6.0.0-alpha.98`
...
- &#8203;<!-- 32 -->[base] Ban default exports (#38200) @michaldudak
  ...
  ```diff
  - import Button, { buttonClasses } from 'my-mui/base/Button';
  + import { Button, buttonClasses } from 'my-mui/base/Button';
  - import BaseMenu from 'my-mui/base/Menu';
  + import { Menu as BaseMenu } from 'my-mui/base/Menu';
  ```

  Additionally, the `ClassNameGenerator` has been moved to the directory matching its name:

  ```diff
  - import ClassNameGenerator from 'my-mui/base/className';
  + import { ClassNameGenerator } from 'my-mui/base/ClassNameGenerator';
  ```

  A codemod is provided to help with the migration:

  ```bash
  npx my-mui/codemod@latest v5.0.0/base-use-named-exports <path>
  ```
...
### `my-mui/joy@5.0.0-beta.0`

- &#8203;<!-- 10 -->[joy] Refine the default theme (#36843) @siriwatknp

### `my-mui/material-next@6.0.0-alpha.95`
...
### `my-mui/material-next@6.0.0-alpha.93`
...
- [docs][material] Rename custom tab panel in Tabs demo to prevent confusion with my-mui/lab (#37638) @MUK-Dev
...
- &#8203;<!-- 04 -->[utils] Allow nested imports in my-mui/utils to speed up build (#37586) @flaviendelangle
...
- The `component` prop is no longer supported because it can be replaced with the slots API. This is how the transformation will look like:
  ...
  ```bash
  npx my-mui/codemod@latest v5.0.0/base-remove-component-prop <path>
  ```
...
- &#8203;<!-- 27 -->[base] Remove unstyled suffix from Base components + Codemod script (#36873) @hbjORbj
  ...
  ```bash
  npx my-mui/codemod@latest v5.0.0/base-remove-unstyled-suffix <path>
  ```
...
### `my-mui/icons-material@5.11.16`

- [icons] Do not ignore popular icons (#36608) @michaldudak

### `my-mui/joy@5.0.0-alpha.74`
...
- &#8203;<!-- 27 -->[Select][base] Add the multiselect functionality to SelectUnstyled (#36274) @michaldudak
  ...
  ```diff
  -import MultiSelectUnstyled from 'my-mui/base/MultiSelectUnstyled';
  +import SelectUnstyled from 'my-mui/base/SelectUnstyled';
...
- &#8203;<!-- 18 -->[docs] Fix my-mui/styles example links (#36331) @oliviertassinari
...
- &#8203;<!-- 28 -->[base] Move hooks to their own directories (#36235) @hbjORbj
  ...
  ```diff
  -import { useBadge } from 'my-mui/base/BadgeUnstyled';
...
### `my-mui/material-next@6.0.0-alpha.75`
...
- [docs] Fix typo in the released version of my-mui/styled-engine (#36121) @m4theushw
...
### `my-mui/system@5.11.8`

- &#8203;<!-- 05 -->[System] Fix nested grid v2 (#35994) @siriwatknp

### `my-mui/styled-engine@5.11.8`
...
### `my-mui/material-next@6.0.0-alpha.68`
...
- [system] Enable configuring the `sx` prop in the `theme` (#35150) @mnajdova
  ...
  ```diff
  -import { styled, experimental_sx } from 'my-mui/material/styles';
...
- [core] Fix my-mui/material package building (#35324) @timbset
...
### `my-mui/system@5.10.14`

- [Unstable_Gridv2] sorted responsize keys based on breakpoint value (#34987) @sai6855

### `my-mui/joy@5.0.0-alpha.54`

- [Joy] Export `FormControl`, `LinearProgress` and `ListSubheader` components from `my-mui/joy` (#35003) @Studio384
